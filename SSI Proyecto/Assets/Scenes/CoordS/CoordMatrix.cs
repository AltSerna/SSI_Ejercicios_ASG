...
public class CoordMatrix : MonoBehaviour
{
[Header("Matrix transform")]
    ...
    Matrix4x4 matrix;
    Vector3 otherObjectInitialPos;

    private void Start()
    {
        otherObjectInitialPos = otherObject.position;
    }
    private void Update()
    {
    ...
    private void UpateOtherObject()
    {
        ...
        otherObject.position = otherObjectInitialPos;
